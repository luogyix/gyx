...
<html>
	...
	<script type="text/javascript">
		...
		function loadPage(){
			...
			var pagequeryObj = new PageQuery(
				...
				'<%=basePath%>/dataAnalysis/waitingTime_queryTime',
				['branch','branch_name','date','less3','more3less5','more5less10','more10less15','more15less20','more20less30','more30','total_waiting_time','average_waiting_time','total_count'],
				[
				{header:'全选'},
				{header:'复选框'},
				{header:'机构号',dataIndex:'branch',width:65},
				{header:'机构名',dataIndex:'branch_name',width:120},
				{header:'日期',dataIndex:'date',width:90,sortable:true},
  ...
  <body>
	...
	<s:form action="/dataAnalysis/waitingTime_exportExcel" target="REPORTRESULTFRAME">
