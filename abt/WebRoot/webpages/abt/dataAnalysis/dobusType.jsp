 ...
 */	
		...
		function loadPage(){
			...
			var conditionPanel = new SelfToolBarPanel('queryConditionPanel', '业务类别统计', 120, 1,
				[
			...
			var pagequeryObj = new PageQuery(
				...
				'<%=basePath%>/dataAnalysis/dobusType_queryType',
				['branch','branch_name','date','queue_bus_type','bus_type_name','dobus_count','avgservtime',
				 'total_service_time','avgwaittime','total_wait_time'],
				[
				{header:'全选'},
				{header:'复选框'},
				{header:'机构号', dataIndex:'branch',width:120},
				{header:'机构名', dataIndex:'branch_name',width:150},
				{header:'日期',  dataIndex:'date',width:150,sortable:true},
				{header:'业务编号',dataIndex:'queue_bus_type',width:150,sortable:true},
				{header:'业务名称',dataIndex:'bus_type_name',width:150,sortable:true},
				{header:'办理人数',dataIndex:'dobus_count',width:150,sortable:true},
				{header:'平均等待时间(分钟)',dataIndex:'avgwaittime',width:180,sortable:true},
				{header:'累积等待时间(分钟)',dataIndex:'total_wait_time',width:180,sortable:true},
				{header:'平均办理时间(分钟)',dataIndex:'avgservtime',width:180,sortable:true},
				{header:'累积办理时间(分钟)',dataIndex:'total_service_time',width:235,sortable:true}
  ...
  <body scroll="no">
	...
	<s:form action="/dataAnalysis/dobusType_exportExcel" target="REPORTRESULTFRAME">
