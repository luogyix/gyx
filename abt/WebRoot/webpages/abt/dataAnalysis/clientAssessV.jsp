 ...
 */
		...
		function loadPage(){
			...
			var conditionPanel = new SelfToolBarPanel('queryConditionPanel', '客户评价统计', 120, 2,
				...
				{rowIndex:1, field:{xtype:'datefield',editable:false, 	name:'startDate', fieldLabel:'开始时间',format:'Y-m-d',value:new Date(new Date().setDate(new Date().getDate() - 30)),  allowBlank : false}},
				{rowIndex:1, field:{xtype:'datefield',editable:false, 	name:'endDate',   fieldLabel:'结束时间',format:'Y-m-d',value:new Date(),  allowBlank : false}}
				],
				[
			...
			var pagequeryObj = new PageQuery(
				...
				'<%=basePath%>/dataAnalysis/clientAssessV_queryAssess.action',
				['branch','branch_name','date','teller','teller_name','total_call_num','total_service_num','total_assess_num',
					...
					'genl_satisfy_rate','not_satisfy_rate','not_evaluate_rate','not_sed_evaluate_rate','serviceratings','serviceratings_avg'],
				[
				{header:'全选'},
				{header:'复选框'},
				...
				{header:'柜员未发起评价率',dataIndex:'not_sed_evaluate_rate',width:120,sortable:true},
				{header:'服务评分',dataIndex:'serviceratings',width:70,sortable:true},
				{header:'服务平均分',dataIndex:'serviceratings_avg',width:150,sortable:true}
				],
  ...
  <body scroll="no">
	...
	<s:form action="/dataAnalysis/clientAssessV_exportExcel" target="REPORTRESULTFRAME">
