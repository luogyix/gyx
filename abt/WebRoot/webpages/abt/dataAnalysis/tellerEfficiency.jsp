 ...
 */
		...
		function loadPage(){
			...
			var pagequeryObj = new PageQuery(
				...
				'<%=basePath%>dataAnalysis/tellerEfficiency_queryeEfficiency',
				['branch','branch_name','date','teller','teller_name','people_count',
				...
				{header:'累积客户用时(分钟)',dataIndex:'total_use_time',width:265,sortable:true}
				],
  ...
  <body scroll="no">
	...
	<s:form action="/dataAnalysis/tellerEfficiency_exportExcel" target="REPORTRESULTFRAME">
