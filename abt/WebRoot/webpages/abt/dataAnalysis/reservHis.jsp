  ...
  <head>
	...
	<script type="text/javascript">
		...
		var custinfoTypeStore = new Ext.data.SimpleStore({ 
			data:[
			['0','0-身份证'],['1','1-银行卡卡号'],['2','2-客户号'],['3','3-护照号码'],
 ...
 */	    var systemUnits=pagereturn.field1;
		function loadPage(){
			...
			var conditionPanel = new SelfToolBarPanel('queryConditionPanel', '预约历史查询', 120, 2,
				[
				...
				{rowIndex:1, field:{xtype:'datefield',editable:false, 	name:'startdate',   format:'Y-m-d',value:new Date(new Date().setDate(new Date().getDate() - 30)),allowBlank : false, fieldLabel:'预约开始日期'}},
			...
			var pagequeryObj = new PageQuery(
				...
				'<%=basePath%>/dataAnalysis/reservHis_queryReservHistory',
				[
					...
					{header:'预约业务编号',dataIndex:'reserv_bs_id',width:100,hidden:true, renderer:function(value){
  ...
  <body scroll="no">
	...
	<s:form action="/dataAnalysis/reservHis_exportReservHistory" target="REPORTRESULTFRAME" namespace="./">
