...
<script type="text/javascript" src="selfjs/pagequery/pagequery.js"></script>
	<script type="text/javascript">
		...
		var yewuStore=new Ext.data.SimpleStore({ 
			data:[["1","1-业务1"],["2","2-业务2"]],
			fields : ['key','value']
		});
 ...
 */
		function loadPage(){
			...
			var conditionPanel = new SelfToolBarPanel('queryConditionPanel', '预约业务配置', 120, 0,
				[
				],
				[
			...
			var pagequeryObj = new PageQuery(
				...
				{header:'业务编号',dataIndex:'custtype_e',width:100},
				{header:'名称',dataIndex:'custtype_name',width:100},
				{header:'状态',dataIndex:'custtype_level',width:100}
				],
				'<s:text name="common.pagequery.pagingtool"/>'
			);
			
			//当选择"添加"时，弹出的窗口
			addwindow = new SelfFormWindow('addWindow', '添加预约业务', 300, 260, 200, 1,
				[
				{colIndex:0, field:{xtype : 'combo', name:'custtype_name', 	fieldLabel:'选择业务',value:'1-业务1', 	allowBlank : false, blankText:'请选择业务',editable:false, store:yewuStore, 	displayField:'value', valueField:'key'}},
				{colIndex:0, field:{xtype : 'combo',     name:'isvip',   fieldLabel:'状态',	allowBlank : true, hiddenName:'isVip',forceSelection: true, store:subStatusStore, 	displayField:'value', valueField:'key'}}
				],
				[
			...
			//选择"修改"时，弹出的窗口
			editwindow = new SelfFormWindow('editWindow', '编辑预约业务', 300, 260, 200, 1,
			   [
