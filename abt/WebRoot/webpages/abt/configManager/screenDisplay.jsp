 ...
 */		var priv=pagereturn.field2;
		function loadPage(){
			...
			var conditionPanel = new SelfToolBarPanel('queryConditionPanel', '条屏信息配置', 120, 0,
				[
				],
				[
			...
			var pagequeryObj = new PageQuery(
				...
				'<%=basePath%>confManager/screenDisplay_queryScreenPage',
				['branch','screen_id','default_flag','free_content','free_style','free_speed','call_content','call_style','call_speed','pause_content','pause_style','pause_speed','serve_content','serve_style','serve_speed'],
				[
				{header:'全选'},
				{header:'复选框'},
				...
				{header:'窗口显示时切换时间(秒)',dataIndex:'call_speed',width:180,renderer:function(value){
					value = value.toString();
					return "0"==value?"无限大":value;//翻译字段方法
       			 }},
				...
				{header:'窗口正在办理时切换时间(秒)',dataIndex:'serve_speed',width:220,renderer:function(value){
					value = value.toString();
					return "0"==value?"无限大":value;//翻译字段方法
       			 }}*/
				],
			...
			addwindow = new SelfFormWindow('addWindow', '添加条屏信息', 600, 350, 160, 3,
				/*
				设置弹窗中的内容：
					field下的xtype指定弹窗中子组件的类型：textfield=>输入框，combo=>下拉框
					field下的store指定弹窗中下拉框中的选项，通过之前设置的变量名引入
				*/
				[
				{colIndex:0, field:{xtype : 'textfield', name:'free_content',id:'free_content_add', 	fieldLabel:'窗口空闲时显示内容', 	allowBlank : false, blankText:'请输入显示内容',maxLength : 100,	maxLengthText : '长度不能大于100位'	}},
				{colIndex:1, field:{xtype : 'combo',     name:'free_style',id:'free_style_add',   fieldLabel:'窗口空闲时显示效果',	allowBlank : false, hiddenName:'free_style',value:0,editable:false,blankText : '请选择显示效果', store:styleStore, 	displayField:'value', valueField:'key'}},
				{colIndex:2, field:{xtype : 'textfield', name:'free_speed',id:'free_speed_add', 	fieldLabel:'窗口空闲时切换时间(秒)', 	allowBlank : false, blankText:'请输入切换时间',maxLength : 5,	maxLengthText : '长度不能大于5位',regex:/^[0-9]*$/,regexText:'只能输入数字'}},
				{colIndex:0, field:{xtype : 'textfield', name:'call_content',id:'call_content_add', 	fieldLabel:'窗口叫号时显示内容', 	allowBlank : false, blankText:'请输入显示内容',maxLength : 100,	maxLengthText : '长度不能大于100位'	}},
				{colIndex:1, field:{xtype : 'combo',     name:'call_style',id:'call_style_add',   fieldLabel:'窗口叫号时显示效果',	allowBlank : false, hiddenName:'call_style',value:0,editable:false,blankText : '请选择显示效果', store:styleStore, 	displayField:'value', valueField:'key'}},
				{colIndex:2, field:{xtype : 'textfield', name:'call_speed',id:'call_speed_add', 	fieldLabel:'窗口显示时切换时间(秒)', 	allowBlank : false, blankText:'请输入切换时间',maxLength : 5,	maxLengthText : '长度不能大于5位',regex:/^[0-9]*$/,regexText:'只能输入数字'}},
				{colIndex:0, field:{xtype : 'textfield', name:'pause_content',id:'pause_content_add', 	fieldLabel:'窗口暂停时显示内容', 	allowBlank : false, blankText:'请输入显示内容',maxLength : 100,	maxLengthText : '长度不能大于100位'	}},
				{colIndex:1, field:{xtype : 'combo',     name:'pause_style',id:'pause_style_add',   fieldLabel:'窗口暂停时显示效果',	allowBlank : false, hiddenName:'pause_style',value:0,editable:false,blankText : '请选择显示效果', store:styleStore, 	displayField:'value', valueField:'key'}},
				{colIndex:2, field:{xtype : 'textfield', name:'pause_speed',id:'pause_speed_add', 	fieldLabel:'窗口暂停时切换时间(秒)', 	allowBlank : false, blankText:'请输入切换时间',maxLength : 5,	maxLengthText : '长度不能大于5位',regex:/^[0-9]*$/,regexText:'只能输入数字'}},
/*				{colIndex:0, field:{xtype : 'textfield', name:'serve_content',id:'serve_content_add', 	fieldLabel:'窗口正在办理时显示内容', 	allowBlank : false, blankText:'请输入显示内容',maxLength : 100,	maxLengthText : '长度不能大于100位',hidden:true}},
				{colIndex:1, field:{xtype : 'combo',     name:'serve_style',id:'serve_style_add',   fieldLabel:'窗口正在办理时显示效果',	allowBlank : false, hiddenName:'serve_style',value:0,editable:false,blankText : '请选择显示效果', store:styleStore, 	displayField:'value', valueField:'key',hidden:true}},
				{colIndex:2, field:{xtype : 'textfield', name:'serve_speed',id:'serve_speed_add', 	fieldLabel:'窗口正在办理时切换时间(秒)', 	allowBlank : false, blankText:'请输入切换时间',maxLength : 5,	maxLengthText : '长度不能大于5位',regex:/^[0-9]*$/,regexText:'只能输入数字',hidden:true}},
*/				{colIndex:0, hiddenLabel:true,field:{width:240,html:'<font color="red">注:     排队号:@@@@@,窗口:##</font>'}},
			...
			//选择"修改"时，弹出的窗口
			editwindow = new SelfFormWindow('editWindow', '编辑条屏信息', 600, 350, 160, 3,
			   [
				{colIndex:0, field:{xtype : 'textfield', name:'branch', 	fieldLabel:'机构号',id:'branch', readOnly:true , hidden:true}},
				{colIndex:1, field:{xtype : 'textfield', name:'screen_id', 	fieldLabel:'条屏信息编号',id:'screen_id', readOnly:true, hidden:true}},
				{colIndex:0, field:{xtype : 'textfield', name:'free_content',id:'free_content_edit', 	fieldLabel:'窗口空闲时显示内容', 	allowBlank : false, blankText:'请输入显示内容',maxLength : 100,	maxLengthText : '长度不能大于100位'	}},
				{colIndex:1, field:{xtype : 'combo',     name:'free_style', id:'free_style_edit',   fieldLabel:'窗口空闲时显示效果',	allowBlank : false, hiddenName:'free_style',value:0,editable:false,blankText : '请选择显示效果', store:styleStore, 	displayField:'value', valueField:'key'}},
				{colIndex:2, field:{xtype : 'textfield', name:'free_speed',id:'free_speed_edit', 	fieldLabel:'窗口空闲时切换时间(秒)', 	allowBlank : false, blankText:'请输入切换时间',maxLength : 5,	maxLengthText : '长度不能大于5位',regex:/^[0-9]*$/,regexText:'只能输入数字'}},
				{colIndex:0, field:{xtype : 'textfield', name:'call_content',id:'call_content_edit', 	fieldLabel:'窗口叫号时显示内容', 	allowBlank : false, blankText:'请输入显示内容',maxLength : 100,	maxLengthText : '长度不能大于100位'	}},
				{colIndex:1, field:{xtype : 'combo',     name:'call_style',id:'call_style_edit',   fieldLabel:'窗口叫号时显示效果',	allowBlank : false, hiddenName:'call_style',value:0,editable:false,blankText : '请选择显示效果', store:styleStore, 	displayField:'value', valueField:'key'}},
				{colIndex:2, field:{xtype : 'textfield', name:'call_speed',id:'call_speed_edit', 	fieldLabel:'窗口显示时切换时间(秒)', 	allowBlank : false, blankText:'请输入切换时间',maxLength : 5,	maxLengthText : '长度不能大于5位',regex:/^[0-9]*$/,regexText:'只能输入数字'}},
				{colIndex:0, field:{xtype : 'textfield', name:'pause_content',id:'pause_content_edit', 	fieldLabel:'窗口暂停时显示内容', 	allowBlank : false, blankText:'请输入显示内容',maxLength : 100,	maxLengthText : '长度不能大于100位'	}},
				{colIndex:1, field:{xtype : 'combo',     name:'pause_style',id:'pause_style_edit',   fieldLabel:'窗口暂停时显示效果',	allowBlank : false, hiddenName:'pause_style',value:0,editable:false,blankText : '请选择显示效果', store:styleStore, 	displayField:'value', valueField:'key'}},
				{colIndex:2, field:{xtype : 'textfield', name:'pause_speed',id:'pause_speed_edit', 	fieldLabel:'窗口暂停时切换时间(秒)', 	allowBlank : false, blankText:'请输入切换时间',maxLength : 5,	maxLengthText : '长度不能大于5位',regex:/^[0-9]*$/,regexText:'只能输入数字'}},
				
				{colIndex:0, field:{xtype : 'textfield', name:'serve_content',id:'serve_content_edit', 	fieldLabel:'窗口正在办理时显示内容', 	allowBlank : false, blankText:'请输入显示内容',maxLength : 100,	maxLengthText : '长度不能大于100位',hidden:true}},
				{colIndex:1, field:{xtype : 'combo',     name:'serve_style',id:'serve_style_edit',   fieldLabel:'窗口正在办理时显示效果',	allowBlank : false, hiddenName:'serve_style',value:0,editable:false,blankText : '请选择显示效果', store:styleStore, 	displayField:'value', valueField:'key',hidden:true}},
				{colIndex:2, field:{xtype : 'textfield', name:'serve_speed',id:'serve_speed_edit', 	fieldLabel:'窗口正在办理时切换时间(秒)', 	allowBlank : false, blankText:'请输入切换时间',maxLength : 5,	maxLengthText : '长度不能大于5位',regex:/^[0-9]*$/,regexText:'只能输入数字',hidden:true}},
...
//	    			Ext.getCmp('default_flag_add').setValue(record.data['default_flag']);
			...
			function onButtonClicked(btn_index){
				switch(btn_index){
					...
					case 2:
						...
						break;
					case 3:
					    var submitdata = pagequeryObj.getSelectedObjects(['branch','screen_id']);
						...
						Ext.MessageBox.confirm('<s:text name="common.info.title"/>','<s:text name="common.info.suredelete"/>',function(id){
							if(id === 'yes'){
								requestAjax('<%=basePath%>confManager/screenDisplay_delScreen',submitdata,function(sRet){
			...
			function oneditclicked(){
				...
				requestAjax('<%=basePath%>confManager/screenDisplay_editScreen',submitData,function(sRet){
			...
			*/
			function onaddclicked(){
				...
				createCheckBoxValue('default_flag',submitData);
				requestAjax('<%=basePath%>confManager/screenDisplay_addScreen', submitData,
				function(sRet){
