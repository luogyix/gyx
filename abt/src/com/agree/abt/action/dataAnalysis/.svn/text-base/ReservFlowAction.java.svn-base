...
public class ReservFlowAction extends BaseAction {
	 ...
	 * @throws Exception
	 */
	public String queryReservFlow() throws Exception {
		...
		cona.setBMSHeader("ibp.bds.p207.01", user);
...
//		}
		...
		if(!"0".equals(map.get("btreservqueuenum").get(0))){
			...
			for (int i = 0; i < num; i++) {
				...
				//list.add(map.get("bs_name_ch").get(i));
				list.add(rf);
			}
		}
	 ...
	 * @throws Exception
	 */
	public String exportReservFlow() throws Exception {
