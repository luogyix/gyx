...
public class Base64
{
    ...
    public static String encodeStr(String eString){
    	if(eString==null)return "";

    	return new String(encodeBase64(eString.getBytes()));
    }
    public static String decodeString(String dString){
    	if(dString==null)return "";
    	return new String (decodeBase64(dString.getBytes()));
    }
}
